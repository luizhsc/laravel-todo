  ...
  <div class="w3-padding-32">
    <div class="w3-bar w3-border">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="{{ url('/tarefas/') }}" class="w3-bar-item w3-button">List</a>
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="{{ url('/tags/') }}" class="w3-bar-item w3-button">List</a>
        <a href="{{ url('/tags/create') }}" class="w3-bar-item w3-button">New</a>       
      </div>
    </div>

    <a href="{{ url('/home/') }}" class="w3-bar-item w3-button w3-padding-large">Contact</a>  
